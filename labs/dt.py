...
class DecisionTreeClassifier(object):
    ...
    def __init__(self, max_features=lambda x: x, max_depth=5,
                 min_samples_split=5):
        """
        Args:
    ...
    def build_tree(self, X, y, feature_indices, depth):
        ...
        if depth == self.max_depth or len(y) < self.min_samples_split or entropy(y) == 0:  # 3 критерия остановки
            return mode(y)[0][0]
